...
Cancer immunotherapy (Immuno-oncology or Immunooncology) is a cancer treatment strategy, where the aim is to activate the cancer patient's own immune system to fight the cancer. This post describes some applications of deep learning to cancer immunotherapy research, specifically, for the classification of peptides. Due to the high degree of context dependent interactions, deep learning has already proven invaluble and highly succesful in [modelling the molecular interaction between the Major Histocompability Complex type I (MHCI) and peptides](http://www.cbs.dtu.dk/services/NetMHCpan/) (96.5% of natural peptides are identified at a very high specificity 98.5%).
...
For ease of dissemination the cancer biology background, the neural network architecture and training procedure have been simplified.
